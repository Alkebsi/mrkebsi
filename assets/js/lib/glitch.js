/*
This script was taken from codepen.io by Blaz Kemperle,
the link to the pen is: https://codepen.io/blazicke/pen/dQjxMr
*/
...
var stringRandom = (function() {
    ...
    function resetLetters() {
        ...
        randomArray.forEach(function(el, index){
            ...
            }, (index * 50 * (Math.random() * 5))).toFixed(2);
...
stringRandom.init('.glitch-title');